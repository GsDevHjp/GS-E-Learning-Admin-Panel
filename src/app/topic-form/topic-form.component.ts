...
export class TopicFormComponent implements OnInit {
  ...
  constructor(
    ...
    private matref: MatDialogRef<TopicFormComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.editdata) {
      ...
      this.contentForm.controls['youtubelink'].setValue(this.editdata.youtubelink);
  ...
  addtopic() {
    if (!this.editdata) {
      ...
      conformdata.append('youtubelink', this.contentForm.get('youtubelink')?.value)
  ...
  Updatecontent() {
    ...
    updatedata.append('youtubelink', this.contentForm.get('youtubelink')?.value);
